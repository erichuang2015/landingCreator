...
class SectionFive {
    ...
    function __construct($data, $itemCssClass = 'fivecol-item', $minHeight = '') {
        $this->data = $data;
...
class Prices {
    ...
    function makePriceItem($data) {
        ...
        print_r('<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">'
                ...
                . '<div class="animated fadeInUp" data-toggle="modal" data-target="#myModal">'
                . '<a class="btn btn-success">Заказать</a>'
                . '</div></div></div>');
    }
    ...
    function createBlock() {
        print_r('<section id="prices" class="new-price">'
                ...
                . '<div class="title"><h2>ЦЕНЫ</h2><h3 class="orange">БУХУЧЕТ ДЛЯ ООО И ИП</h3></div></div></div>'
